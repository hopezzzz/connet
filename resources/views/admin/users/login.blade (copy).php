...
@section('content')
    ...
    <div class="col-md-6">
      <div class="tile">
        ...
        <p class="mt-4 mb-4"><a class="btn btn-primary mr-2 mb-2" href="" target="_blank"><i class="fa fa-file"></i>Docs</a><a class="btn btn-info mr-2 mb-2" href="" target="_blank"><i class="fa fa-github"></i>GitHub</a><a class="btn btn-success mr-2 mb-2" href="" target="_blank"><i class="fa fa-download"></i>Download</a></p>
      </div>
    </div>
    <div class="col-md-6">
      <div class="tile">
