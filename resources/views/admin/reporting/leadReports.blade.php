...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-file-o"></i>Lead Reports</h1>
            </div>
                            ...
                            <?php $i=1; $totalCalls=0; ?>
                              @if(isset($data))
                                ...
                                <tr>
                                    ...
                                    <td scope="col">
                                        <a href="@if(isset($cmp->id)) {{ $url.'/campaign-leads/'.Crypt::encrypt($cmp->id) }} @else href = " javascript:void(0) "@endif" data-toggle="tooltip" title="View Leads"><span><i class="fa fa-eye"></i> </span></a>
                                    </td>
                                </tr>
                                <?php 
                                $totalCalls +=$call; 
                                ...
                                @endforelse
                                <tr>
                                    <th scope="col" colspan="2">Total Leads</th>
                                    <th>{{ $totalCalls }}</th>
                                    <th></th>
                                </tr>
                              @else
