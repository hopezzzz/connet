...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Reports</h1>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- <div class="form-group pull-left  col-md-4 nopadding">
                            <input type="text" data-url="{{url('admin/regions')}}" class="form-control" id="searchKey" placeholder="Search Reports by Name , email , phone">
                        </div> -->
